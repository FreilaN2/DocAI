...
export default function Landing() {
  ...
  // Componente memoizado para las características
  const FeatureCard = React.memo(({ icon, title, description, colorClass, iconColor }) => (
    <div className="bg-white/50 dark:bg-[#1a1512]/50 backdrop-blur-md p-8 rounded-3xl border border-slate-200 dark:border-outline-variant/20 shadow-sm flex gap-6 hover:-translate-y-1 transition-transform duration-300">
      <div className={`w-14 h-14 shrink-0 rounded-2xl flex items-center justify-center ${colorClass}`}>
  ...
  // Componente memoizado para el FAQ item
  const FaqItem = React.memo(({ num, isOpen, onToggle }) => (
    <div className="bg-white/70 dark:bg-[#1a1512]/70 backdrop-blur-lg border border-slate-200 dark:border-outline-variant/30 rounded-2xl overflow-hidden">
      <button 
        onClick={() => onToggle(num)}
        className="w-full px-6 py-5 flex items-center justify-between text-left focus:outline-none hover:bg-surface-container-low/50 transition-colors duration-200"
      >
  ...
  return (
    <div className="bg-background min-h-screen text-on-background relative overflow-x-hidden">
      ...
      {/* Fondos estáticos sin animación */}
      ...
      <main className="pt-32 pb-24 px-gutter max-w-container-max mx-auto flex flex-col gap-stack-lg">
        {/* Hero Section */}
        <section className="text-center flex flex-col items-center gap-stack-md pt-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-container border border-outline-variant/30 backdrop-blur-sm mb-4 opacity-0 animate-[fadeIn_0.6s_ease-out_0.2s_forwards]">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-on-surface max-w-4xl mx-auto leading-tight opacity-0 animate-[fadeInUp_0.6s_ease-out_0.4s_forwards]">
            {t('landing.title')} <br/> 
            <span className="text-primary-container">{t('landing.title_highlight')}</span>
          </h1>
          
          <p className="text-lg md:text-xl text-on-surface-variant max-w-2xl mx-auto mt-6 opacity-0 animate-[fadeInUp_0.6s_ease-out_0.6s_forwards]">
            {t('landing.subtitle')}
          </p>
          
          <div className="flex flex-col md:flex-row items-center gap-4 mt-8 opacity-0 animate-[fadeInUp_0.6s_ease-out_0.8s_forwards]">
        ...
        <section className="max-w-4xl mx-auto w-full mt-16 flex flex-col items-center gap-stack-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full px-4 text-left">
            {/* Free Card */}
            <div className="bg-white/70 dark:bg-[#1a1512]/70 backdrop-blur-[20px] rounded-card border border-slate-200 dark:border-outline-variant/30 p-8 flex flex-col shadow-sm relative z-10 hover:-translate-y-2 transition-transform duration-300">
              <div className="mb-6">
            ...
            {/* Pro Card */}
            <div className="bg-white/90 dark:bg-[#1a1512]/90 backdrop-blur-[24px] rounded-card border-2 border-primary-container p-8 flex flex-col shadow-xl relative z-20 transform md:-translate-y-4 hover:-translate-y-6 transition-transform duration-300">
